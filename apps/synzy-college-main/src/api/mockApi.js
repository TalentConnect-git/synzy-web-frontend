...
export const fetchFormSchema = async () => {
  ...
  return {
    'Basic Info': [
      { name: 'name', label: 'college Name', type: 'String', required: true },
      ...
      { name: 'collegeMode', label: 'college Mode', type: 'String', required: true, enum: ['convent', 'private', 'government'] },
      { name: 'genderType', label: 'Gender Type', type: 'String', required: true, enum: ['boy', 'girl', 'co-ed'] },
      { name: 'shifts', label: 'Shifts', type: 'Array', required: true, enum: ['morning', 'afternoon', 'night college'] },
...
export const fetchStudentApplicationSchema = async () => {
  ...
  return {
    ...
    'Previous college Details': [
        { name: 'previouscollege', label: 'Previous college Name', type: 'String', required: false },
